...
| `content_item` | 생성 콘텐츠(대본/카피/문안 + 렌더 스펙) + **훅 패턴·사람 개입 [v2]** + **카테고리 [v3]** | format·status enum, **hook_pattern enum(bold_claim/curiosity/story/shock/question — FR-G5)**, **edited_by_human bool(FR-E3)**, **topic_category enum(신기술/기초지식/꿀팁/현직자일상/개발자유머 — FR-G1·[04](04-트렌드조사.md) §4)** |
